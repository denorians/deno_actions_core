...
import { issue, issueCommand } from "./src/command.ts";
...
// import {OidcClient} from './oidc-utils' // TODO : implement oidc
...
export function addPath(inputPath: string): void {
  ...
  Deno.env.set("PATH", `${inputPath}${sep}${Deno.env.get("PATH")}`);
}
...
export function setOutput(name: string, value: any): void {
  Deno.stdout.write(textEncoder.encode(eol));
...
export function info(message: string): void {
  Deno.stdout.write(textEncoder.encode(message + eol));
}
